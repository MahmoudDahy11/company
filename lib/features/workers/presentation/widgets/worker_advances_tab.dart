      ...
      child: SingleChildScrollView(
        ...
        child: SingleChildScrollView(
          ...
          child: DataTable(
            ...
            rows: advances.map((item) => DataRow(cells: [
              ...
              DataCell(item.carriedOver
                  ? Chip(label: Text(l10n.carryOver), visualDensity: VisualDensity.compact)
                        ...
                        onPressed: () async {
                          final confirm = await showDialog<bool>(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: Text(l10n.confirmDeleteAdvance),
                              actions: [
                          ...
                          if (confirm == true && context.mounted) {
                            context.read<WorkerDetailsCubit>().deleteAdvance(item.id);
                          }
                        },
